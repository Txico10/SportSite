        ...
        'Datatables' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'https://cdn.datatables.net/1.10.25/js/jquery.dataTables.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'https://cdn.datatables.net/1.10.25/js/dataTables.bootstrap4.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => 'https://cdn.datatables.net/1.10.25/css/dataTables.bootstrap4.min.css',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
        ...
        'InputMask' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/inputmask/bindings/inputmask.binding.js',
                ],
            ],
        ],
        'BS-Stepper' => [
